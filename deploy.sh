...
docker push killy/multi-client-k8s:latest
docker push killy/multi-server-k8s:latest
docker push killy/multi-worker-k8s:latest

docker push killy/multi-client-k8s:$GIT_SHA
docker push killy/multi-server-k8s:$GIT_SHA
docker push killy/multi-worker-k8s:$GIT_SHA
